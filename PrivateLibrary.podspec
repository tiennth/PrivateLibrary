...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
This is just a pod for test creating private pods
                       DESC

  s.homepage         = 'https://github.com/tiennth/PrivateLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tien Nguyen' => 'thanhtien2302@gmail.com' }
  s.source           = { :git => 'https://github.com/tiennth/PrivateLibrary.git', :tag => s.version.to_s }
